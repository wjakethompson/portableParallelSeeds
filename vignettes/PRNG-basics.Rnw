...
problem. A revised version of mvrnorm was packaged with rockchalk. 
That guarantees replication of the first block of rows
when a larger simulation is executed. 
